/**
 * =============================================================================
 * 📌 Auth Options — Sierra Tech Auth Gateway
 * Path: src/lib/auth/authOptions.ts
 * =============================================================================
 *
 * ES:
 * Configuración central de autenticación para Sierra Tech.
 *
 * Propósito:
 ...
 *
 * Reglas:
 * - Este archivo sí exporta authOptions.
 * - Este archivo NO exporta handlers GET/POST.
 * - El route.ts solo consume authOptions y exporta NextAuth handler.
 * =============================================================================
 */
	...
	callbacks: {
		...
		async jwt(params: {
			...
			if (user && account?.provider !== "google") {
				...
				const id =
					pickString(normalizedUser._id) ?? pickString(normalizedUser.id) ?? "";
				...
				t.organizationName =
					pickString(normalizedUser.organizationName) ?? null;
			...
			session.user = {
				...
				organizationUserRole:
					typeof t.organizationUserRole === "string"
						...
						: null,
				isRegistered:
					typeof t.isRegistered === "boolean" ? t.isRegistered : false,
