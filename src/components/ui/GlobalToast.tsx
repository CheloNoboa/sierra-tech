...
export default function GlobalToast({
	...
	const variantStyles: Record<ToastVariant, string> = {
		success: "border-l-4 border-status-success bg-surface text-text-primary",
		error: "border-l-4 border-status-error bg-surface text-text-primary",
		warning: "border-l-4 border-status-warning bg-surface text-text-primary",
		info: "border-l-4 border-status-info bg-surface text-text-primary",
	};
