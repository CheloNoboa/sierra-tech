...
export default function ServiceClassModal({
	...
	const [initialSnapshot, setInitialSnapshot] =
		useState<ServiceClassModalShape>(normalizeShape(initialData));
	...
	const t = useMemo(
		() => ({
			...
			discardTitle: lang === "es" ? "Descartar cambios" : "Discard changes",
			discardMessage:
				lang === "es"
					? "Tienes cambios sin guardar. ¿Deseas descartarlos?"
					: "You have unsaved changes. Do you want to discard them?",
			discardConfirm: lang === "es" ? "Descartar cambios" : "Discard changes",
			continueEditing: lang === "es" ? "Seguir editando" : "Keep editing",
		}),
		[lang],
	);
