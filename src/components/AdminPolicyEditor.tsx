...
function normalizePolicies(input: unknown): Policy[] {
  ...
  const es = validPolicies.find((item) => item.lang === "es") ?? createEmptyPolicy("es");
  const en = validPolicies.find((item) => item.lang === "en") ?? createEmptyPolicy("en");
      ...
      {loadingPolicies ? (
        ...
        <div className="space-y-6">
          ...
          <input
            ...
            placeholder={locale === "es" ? "Título de la política" : "Policy title"}
          />
