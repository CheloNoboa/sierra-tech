...
export default function AdminSidebar() {
	...
	const t = {
		...
		siteSettings: locale === "es" ? "Configuración del sitio" : "Site settings",
		...
		organizationUsers:
			locale === "es" ? "Usuarios de organización" : "Organization users",
		...
		seeder:
			locale === "es" ? "Ejecutar Seeder Seguridad" : "Run Security Seeder",
