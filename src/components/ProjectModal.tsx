                  ...
                  <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          const nextId = e.currentTarget.value ? e.currentTarget.value : null;
                          const selected =
              ...
              >
                <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      value={Array.isArray(form.technologyUsed?.es) ? form.technologyUsed.es.join(", ") : ""}
                      onChange={(e) =>
                        patch("technologyUsed", {
                          es: parseCommaSeparatedValues(e.currentTarget.value),
                          en: Array.isArray(form.technologyUsed?.en) ? form.technologyUsed.en : [],
                        })
                      }
                      placeholder={
                        safeLocale === "es"
                  ...
                  <div>
                    ...
                    <input
                      value={Array.isArray(form.technologyUsed?.en) ? form.technologyUsed.en.join(", ") : ""}
                      onChange={(e) =>
                        patch("technologyUsed", {
                          es: Array.isArray(form.technologyUsed?.es) ? form.technologyUsed.es : [],
                                    ...
                                    {item.attachments.map((attachment, attachmentIndex) => (
                                      ...
                                      >
                                        <div className="min-w-0">
                                          ...
                                          <p className="truncate text-xs text-text-muted">
                                            {attachment.mimeType || "file"} · {Math.round((attachment.size || 0) / 1024)} KB
                                          </p>
                                        </div>
