...
function normalizeSavedRole(
	...
	if (isRecord(raw)) {
		...
		const permissionsFromResponse = normalizePermissionCodes(
			source.permissions,
		);
		const permissions =
...
export default function RoleModal({
	...
	const t = useMemo(
		() => ({
			...
			placeholderEs: lang === "es" ? "Nombre en español..." : "Spanish name...",
			placeholderEn: lang === "es" ? "Nombre en inglés..." : "English name...",
