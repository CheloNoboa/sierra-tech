...
function getLocalizedText(
	...
	const preferred =
		locale === "es" ? normalizeString(value.es) : normalizeString(value.en);
	const fallback =
		locale === "es" ? normalizeString(value.en) : normalizeString(value.es);
...
export default function ServicesPageClient({
	...
	const primaryCtaHref =
		normalizeString(pageHeader.primaryCtaHref) || "/contact";
