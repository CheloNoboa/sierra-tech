...
function normalizeSavedOrganization(
	...
	if (context.existingOrganization) {
		...
		const merged: Organization = {
			...
			legalName:
				getString(source?.legalName) ||
				normalizeString(context.values.legalName),
			commercialName:
...
export default function OrganizationModal({
	...
	const t = useMemo(
		() => ({
			...
			commercialName: locale === "es" ? "Nombre comercial" : "Commercial name",
			taxId: locale === "es" ? "RUC / Tax ID" : "Tax ID",
			primaryEmail: locale === "es" ? "Email principal" : "Primary email",
			primaryPhone: locale === "es" ? "Teléfono principal" : "Primary phone",
