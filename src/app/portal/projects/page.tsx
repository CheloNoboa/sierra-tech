...
function formatVisibleStatus(value: PortalProjectCard["visibleStatus"]): string {
  switch (value) {
    case "active":
      return "Activo";
    case "follow_up":
      ...
      <section className="rounded-[30px] border border-border bg-white p-8 shadow-sm">
        <div className="max-w-3xl space-y-4">
          ...
          <p className="text-base leading-8 text-text-secondary">
            ...
            organización, junto con su contexto general, documentación
            asociada, alertas relevantes y próximas fechas de seguimiento.
          </p>
        </div>
      </section>
