...
function buildPayload(form: DocumentFormState) {
  return {
    ...
    fileSizeBytes: form.fileSizeBytes.trim()
...
export default function AdminEditDocumentPage() {
  ...
  const copy = useMemo(() => {
    return {
      ...
      organization: locale === "es" ? "Organización y acceso" : "Organization and access",
      ...
      thumbnailUrl: locale === "es" ? "URL / ruta de miniatura" : "Thumbnail URL / path",
      ...
      relatedEntityId: locale === "es" ? "ID entidad relacionada" : "Related entity ID",
      ...
      updatedByEmail: locale === "es" ? "Email de actualización" : "Update email",
