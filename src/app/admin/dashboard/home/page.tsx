...
export default function HomeAdminPage() {
  ...
  const [form, setForm] = useState<HomePayload>(() => structuredClone(HOME_DEFAULTS));
  const [initialData, setInitialData] = useState<HomePayload>(() => structuredClone(HOME_DEFAULTS));
  const [loading, setLoading] = useState(true);
  const [saving, setSaving] = useState(false);
  const [uploadingLogoPartnerId, setUploadingLogoPartnerId] = useState<string | null>(null);
  ...
  async function handlePartnerLogoSelected(
    ...
    try {
      ...
      toast.success(
        lang === "es" ? "Logo cargado correctamente." : "Logo uploaded successfully."
      );
    } catch (error) {
      console.error("[HomeAdminPage] Partner logo upload error:", error);
      toast.error(
        lang === "es" ? "No se pudo cargar el logo." : "Could not upload the logo."
      );
    } finally {
  ...
  function addCard(): void {
    setForm((prev) => ({
      ...prev,
      featuredCards: [...prev.featuredCards, createEmptyCard(prev.featuredCards.length + 1)],
    }));
  }
  ...
  function removeCard(cardId: string): void {
    setForm((prev) => ({
      ...prev,
      featuredCards: normalizeCards(prev.featuredCards.filter((card) => card.id !== cardId)),
    }));
  }
  ...
  function updatePartnerSectionField(field: "enabled" | "ctaHref", value: boolean | string): void {
    setForm((prev) => ({
      ...prev,
      partnerSection: {
        ...prev.partnerSection,
      ...
      partnerSection: {
        ...
        items: prev.partnerSection.items.map((item) =>
          item.id === partnerId
            ? {
                ...item,
                coverageItems: [...item.coverageItems, createEmptyLocalizedItem()],
              }
            : item
        ),
      },
      ...
      partnerSection: {
        ...
        items: prev.partnerSection.items.map((item) =>
          item.id === partnerId
            ? {
                ...item,
                coverageItems: item.coverageItems.map((coverageItem, itemIndex) =>
                  itemIndex === index
                    ? {
                        ...coverageItem,
                        [localeKey]: value,
      ...
      partnerSection: {
        ...
        items: prev.partnerSection.items.map((item) =>
          item.id === partnerId
            ? {
                ...item,
                coverageItems: item.coverageItems.filter((_, itemIndex) => itemIndex !== index),
              }
            : item
        ),
      },
  ...
  function movePartnerDocument(
    ...
    const partner = form.partnerSection.items.find((item) => item.id === partnerId);
    if (!partner) return;
  ...
  function getPartnerDisplayName(partner: HomePayload["partnerSection"]["items"][number]): string {
  ...
  function removePartnerDocumentFile(partnerId: string, documentId: string): void {
    setForm((prev) => ({
      ...prev,
      partnerSection: {
        ...prev.partnerSection,
  ...
  return (
    <main className="space-y-6">
          ...
          <div className="mt-4 grid gap-5 md:grid-cols-2">
            <div>
              ...
              <TextInput
                ...
                onChange={(e) => updateHeroCtaLabel("primaryCta", "es", e.target.value)}
              />
            </div>
            ...
            <div>
              ...
              <TextInput
                ...
                onChange={(e) => updateHeroCtaLabel("primaryCta", "en", e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="mt-4 grid gap-5 md:grid-cols-2">
            <div>
              ...
              <TextInput
                ...
                onChange={(e) => updateHeroCtaLabel("secondaryCta", "es", e.target.value)}
              />
            </div>
            ...
            <div>
              ...
              <TextInput
                ...
                onChange={(e) => updateHeroCtaLabel("secondaryCta", "en", e.target.value)}
              />
            </div>
          </div>
      ...
      >
        ...
        {form.featuredCards.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border bg-background p-5 text-sm text-text-secondary">
            {lang === "es" ? "No hay cards creadas todavía." : "No cards have been created yet."}
          </div>
        ) : (
              ...
              <div key={card.id} className="rounded-2xl border border-border bg-background p-4">
                <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <ActionButton onClick={() => moveCard(card.id, "up")} disabled={index === 0}>
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  <div>
                    ...
                    <TextInput
                      value={card.title.es}
                      onChange={(e) => updateCardLocalized(card.id, "title", "es", e.target.value)}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <TextInput
                      value={card.title.en}
                      onChange={(e) => updateCardLocalized(card.id, "title", "en", e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div className="mt-4 grid gap-5 md:grid-cols-2">
                  <div>
                    ...
                    <TextArea
                      ...
                      onChange={(e) =>
                        updateCardLocalized(card.id, "description", "es", e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <TextArea
                      ...
                      onChange={(e) =>
                        updateCardLocalized(card.id, "description", "en", e.target.value)
                      }
                    />
                  </div>
                </div>
      ...
      >
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updateCoverageLocalized("eyebrow", "es", e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updateCoverageLocalized("eyebrow", "en", e.target.value)}
            />
          </div>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            ...
            <TextArea
              ...
              onChange={(e) => updateCoverageLocalized("description", "es", e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <TextArea
              ...
              onChange={(e) => updateCoverageLocalized("description", "en", e.target.value)}
            />
          </div>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            <FieldLabel>{lang === "es" ? "Botón abrir mapas ES" : "Open maps button ES"}</FieldLabel>
            <TextInput
              value={form.coverageSection.openMapsLabel.es}
              onChange={(e) => updateCoverageLocalized("openMapsLabel", "es", e.target.value)}
            />
          </div>

          <div>
            <FieldLabel>{lang === "es" ? "Botón abrir mapas EN" : "Open maps button EN"}</FieldLabel>
            <TextInput
              value={form.coverageSection.openMapsLabel.en}
              onChange={(e) => updateCoverageLocalized("openMapsLabel", "en", e.target.value)}
            />
          </div>
        </div>

        <Toggle
          label={lang === "es" ? "Mostrar enlace abrir mapas" : "Show open maps link"}
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updatePartnerSectionLocalized("eyebrow", "es", e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updatePartnerSectionLocalized("eyebrow", "en", e.target.value)}
            />
          </div>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updatePartnerSectionLocalized("title", "es", e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updatePartnerSectionLocalized("title", "en", e.target.value)}
            />
          </div>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            ...
            <TextArea
              ...
              onChange={(e) => updatePartnerSectionLocalized("description", "es", e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <TextArea
              ...
              onChange={(e) => updatePartnerSectionLocalized("description", "en", e.target.value)}
            />
          </div>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updatePartnerSectionLocalized("badgeLabel", "es", e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updatePartnerSectionLocalized("badgeLabel", "en", e.target.value)}
            />
          </div>
        </div>

        <div className="rounded-2xl border border-border bg-background p-4">
          <SectionTitle>{lang === "es" ? "CTA general del bloque" : "General block CTA"}</SectionTitle>
          ...
          <div className="mt-4 grid gap-5 md:grid-cols-2">
            <div>
              ...
              <TextInput
                ...
                onChange={(e) => updatePartnerSectionLocalized("ctaLabel", "es", e.target.value)}
              />
            </div>
            ...
            <div>
              ...
              <TextInput
                ...
                onChange={(e) => updatePartnerSectionLocalized("ctaLabel", "en", e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="mt-4">
            ...
            <TextInput
              ...
              onChange={(e) => updatePartnerSectionField("ctaHref", e.target.value)}
            />
          </div>
        </div>
                ...
                >
                  <div className="mb-5 rounded-2xl border border-border bg-surface p-4">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-text-secondary">
                            ...
                            <span>
                              ...
                              {lang === "es" ? "documento(s) activos" : "active document(s)"}
                            </span>
                            <span>•</span>
                            <span>
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        <ActionButton type="button" onClick={() => togglePartnerExpanded(partner.id)}>
                          {isPartnerExpanded ? (
                  ...
                  {isPartnerExpanded ? (
                    <div className="space-y-5">
                      <Toggle
                        ...
                        onChange={(value) => updatePartnerField(partner.id, "enabled", value)}
                      />
                      ...
                      <div className="grid gap-5 md:grid-cols-2">
                        ...
                        <div>
                          <FieldLabel>{lang === "es" ? "Nombre corto" : "Short name"}</FieldLabel>
                          <TextInput
                            value={partner.shortName}
                            onChange={(e) =>
                              updatePartnerField(partner.id, "shortName", e.target.value)
                            }
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid gap-5 md:grid-cols-2">
                        <div>
                          ...
                          <TextInput
                            ...
                            onChange={(e) =>
                              updatePartnerLocalized(partner.id, "badgeLabel", "es", e.target.value)
                            }
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <TextInput
                            ...
                            onChange={(e) =>
                              updatePartnerLocalized(partner.id, "badgeLabel", "en", e.target.value)
                            }
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid gap-5 md:grid-cols-2">
                        <div>
                          ...
                          <TextArea
                            ...
                            onChange={(e) =>
                              updatePartnerLocalized(partner.id, "summary", "es", e.target.value)
                            }
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <TextArea
                            ...
                            onChange={(e) =>
                              updatePartnerLocalized(partner.id, "summary", "en", e.target.value)
                            }
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid gap-5 md:grid-cols-2">
                        <div>
                          ...
                          <TextArea
                            ...
                            onChange={(e) =>
                              updatePartnerLocalized(partner.id, "description", "es", e.target.value)
                            }
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <TextArea
                            ...
                            onChange={(e) =>
                              updatePartnerLocalized(partner.id, "description", "en", e.target.value)
                            }
                          />
                        </div>
                      </div>
                        ...
                        <div className="mt-4 grid gap-5 lg:grid-cols-[220px_1fr]">
                              ...
                              {partner.logo.url ? (
                                ...
                                <div className="flex flex-col items-center gap-2 text-text-secondary">
                                  ...
                                  <span className="text-xs">
                                    {lang === "es" ? "Sin logo cargado" : "No logo uploaded"}
                                  </span>
                                </div>
                              )}
                            </div>
                          ...
                          <div className="space-y-4">
                            <div className="grid gap-4 md:grid-cols-2">
                              ...
                              <div>
                                <FieldLabel>{lang === "es" ? "Nombre de archivo" : "File name"}</FieldLabel>
                                <TextInput
                                  value={partner.logo.fileName || (lang === "es" ? "Sin archivo" : "No file")}
                                  readOnly
                                />
                              </div>
                              ...
                              <div>
                                <FieldLabel>{lang === "es" ? "Tamaño (bytes)" : "Size (bytes)"}</FieldLabel>
                                <TextInput value={String(partner.logo.sizeBytes)} readOnly />
                              </div>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              <ActionButton
                                ...
                                onClick={() => logoFileInputsRef.current[partner.id]?.click()}
                              >
                      ...
                      <div className="rounded-2xl border border-border bg-surface p-4">
                        <div className="mb-4 flex items-center justify-between gap-3">
                          ...
                          <ActionButton onClick={() => addPartnerCoverageItem(partner.id)}>
                            <Plus className="mr-2 h-4 w-4" />
                        ...
                        {partner.coverageItems.length === 0 ? (
                          <div className="rounded-xl border border-dashed border-border bg-background p-4 text-sm text-text-secondary">
                            {lang === "es" ? "No hay items de cobertura." : "No coverage items yet."}
                          </div>
                        ) : (
                          <div className="space-y-4">
                            {partner.coverageItems.map((item, itemIndex) => (
                              ...
                              >
                                <div className="mb-3 flex items-center justify-between gap-3">
                                  ...
                                  <ActionButton onClick={() => removePartnerCoverageItem(partner.id, itemIndex)}>
                                    <Trash2 className="h-4 w-4" />
                                  </ActionButton>
                                </div>
                            ...
                            {partner.tags.map((item, itemIndex) => (
                              ...
                              >
                                <div className="mb-3 flex items-center justify-between gap-3">
                                  ...
                                  <ActionButton onClick={() => removePartnerTag(partner.id, itemIndex)}>
                                    <Trash2 className="h-4 w-4" />
                                  </ActionButton>
                                </div>
                                ...
                                <div className="grid gap-5 md:grid-cols-2">
                                  <div>
                                    ...
                                    <TextInput
                                      value={item.es}
                                      onChange={(e) =>
                                        updatePartnerTag(partner.id, itemIndex, "es", e.target.value)
                                      }
                                    />
                                  </div>
                                  ...
                                  <div>
                                    ...
                                    <TextInput
                                      value={item.en}
                                      onChange={(e) =>
                                        updatePartnerTag(partner.id, itemIndex, "en", e.target.value)
                                      }
                                    />
                                  </div>
                                </div>
                      ...
                      <div className="rounded-2xl border border-border bg-surface p-4">
                        <SectionTitle>{lang === "es" ? "CTA del partner" : "Partner CTA"}</SectionTitle>
                        ...
                        <div className="mt-4 grid gap-5 md:grid-cols-2">
                          <div>
                            ...
                            <TextInput
                              ...
                              onChange={(e) =>
                                updatePartnerLocalized(partner.id, "ctaLabel", "es", e.target.value)
                              }
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <TextInput
                              ...
                              onChange={(e) =>
                                updatePartnerLocalized(partner.id, "ctaLabel", "en", e.target.value)
                              }
                            />
                          </div>
                        </div>
                        ...
                        <div className="mt-4">
                          ...
                          <TextInput
                            ...
                            onChange={(e) => updatePartnerField(partner.id, "ctaHref", e.target.value)}
                          />
                        </div>
                      </div>
                      ...
                      <div className="rounded-2xl border border-border bg-surface p-4">
                        <div className="mb-4 flex items-center justify-between gap-3">
                          <div className="flex items-center gap-2">
                            ...
                            <SectionTitle>{lang === "es" ? "Documentos" : "Documents"}</SectionTitle>
                          </div>

                          <ActionButton onClick={() => addPartnerDocument(partner.id)}>
                            <Plus className="mr-2 h-4 w-4" />
                        ...
                        {partner.documents.length === 0 ? (
                          ...
                          <div className="space-y-4">
                            {sortPartnerDocuments(partner.documents).map((document, docIndex, docsList) => {
                              const documentKey = `${partner.id}:${document.id}`;
                              const isUploadingDocument = uploadingDocumentKey === documentKey;
                              const isDocumentExpanded = expandedDocuments[documentKey] ?? true;
                              const documentDisplayName = getDocumentDisplayName(document, lang);
                              const hasDocumentFile = document.file.url.trim().length > 0;
                              const documentHasTitle = hasLocalizedText(document.title);
                              const documentIsValid = !document.enabled || (documentHasTitle && hasDocumentFile);
                              ...
                              return (
                                ...
                                >
                                  <div className="mb-4 rounded-2xl border border-border bg-surface p-4">
                                    <div className="flex flex-wrap items-start justify-between gap-3">
                                      <div className="min-w-0">
                                        ...
                                        <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-text-secondary">
                                          <span>
                                            {lang === "es" ? "Documento" : "Document"} #{document.order}
                                          </span>
                                          <span>•</span>
                                          <span>
                                            {document.enabled
                                      ...
                                      <div className="flex flex-wrap items-center gap-2">
                                        <ActionButton
                                          type="button"
                                          onClick={() => toggleDocumentExpanded(documentKey)}
                                        >
                                          {isDocumentExpanded ? (
                                            <ChevronUp className="h-4 w-4" />
                                          ) : (
                                        ...
                                        <ActionButton
                                          onClick={() => movePartnerDocument(partner.id, document.id, "up")}
                                          disabled={docIndex === 0}
                                        >
                                          <ArrowUp className="h-4 w-4" />
                                        </ActionButton>
                                        ...
                                        <ActionButton
                                          onClick={() => movePartnerDocument(partner.id, document.id, "down")}
                                          disabled={docIndex === docsList.length - 1}
                                        >
                                          <ArrowDown className="h-4 w-4" />
                                        </ActionButton>

                                        <ActionButton
                                          onClick={() => removePartnerDocument(partner.id, document.id)}
                                          className="text-status-error hover:text-status-error"
                                        >
                                          <Trash2 className="h-4 w-4" />
                                        </ActionButton>
                                  ...
                                  {isDocumentExpanded ? (
                                    <div className="space-y-4">
                                      <Toggle
                                        label={lang === "es" ? "Documento activo" : "Document enabled"}
                                        checked={document.enabled}
                                        onChange={(value) =>
                                          updatePartnerDocumentField(partner.id, document.id, "enabled", value)
                                        }
                                      />
                                      ...
                                      <div className="grid gap-5 lg:grid-cols-[220px_1fr]">
                                            ...
                                            {hasDocumentFile ? (
                                              document.file.mimeType.startsWith("image/") ? (
                                                ...
                                                <div className="flex flex-col items-center gap-2 text-text-secondary">
                                                  ...
                                                  <span className="text-xs">
                                                    {lang === "es" ? "Archivo cargado" : "File uploaded"}
                                                  </span>
                                                </div>
                                              )
                                            ) : (
                                        ...
                                        <div className="space-y-4">
                                          <input
                                            ref={(node) => {
                                              documentFileInputsRef.current[documentKey] = node;
                                            }}
                                            type="file"
                                            ...
                                            onChange={(event) => {
                                              const file = event.currentTarget.files?.[0] ?? null;
                                              void handlePartnerDocumentSelected(partner.id, document.id, file);
                                            }}
                                          />
                                          ...
                                          <div className="grid gap-4 md:grid-cols-2">
                                            ...
                                            <div>
                                              <FieldLabel>MIME Type</FieldLabel>
                                              <TextInput value={document.file.mimeType} readOnly />
                                            </div>

                                            <div>
                                              <FieldLabel>Storage Key</FieldLabel>
                                              <TextInput value={document.file.storageKey} readOnly />
                                            </div>

                                            <div>
                                              <FieldLabel>{lang === "es" ? "Tamaño (bytes)" : "Size (bytes)"}</FieldLabel>
                                              <TextInput value={String(document.file.sizeBytes)} readOnly />
                                            </div>
                                          </div>
                                          ...
                                          <div className="flex flex-wrap gap-2">
                                            <ActionButton
                                              ...
                                              onClick={() => documentFileInputsRef.current[documentKey]?.click()}
                                            >
                                              <Upload className="mr-2 h-4 w-4" />
                                              {isUploadingDocument
                                                ? lang === "es"
                                            ...
                                            {hasDocumentFile ? (
                                              <>
                                                ...
                                                <ActionButton
                                                  type="button"
                                                  onClick={() => removePartnerDocumentFile(partner.id, document.id)}
                                                  className="text-status-error hover:text-status-error"
                                                >
                                                  <X className="mr-2 h-4 w-4" />
                                                  {lang === "es" ? "Quitar archivo" : "Remove file"}
                                                </ActionButton>
                                              </>
                                            ) : null}
                                          </div>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updateMapField("fallbackLat", safeNumberFromInput(e.target.value))}
            />
          </div>
          ...
          <div>
            ...
            <TextInput
              ...
              onChange={(e) => updateMapField("fallbackLng", safeNumberFromInput(e.target.value))}
            />
          </div>
          ...
          <div>
            ...
            <TextInput
              ...
              onChange={(e) =>
                updateMapField(
                  "zoom",
                  Number.isFinite(Number(e.target.value)) ? Number(e.target.value) : 7
                )
              }
            />
          </div>
