...
import {
	GlobalToastProvider,
	useToast,
} from "@/components/ui/GlobalToastProvider";
		...
		<GlobalToastProvider>
			<div className="p-6 space-y-10">
				...
				<section className="space-y-4">
					...
					<GlobalButton onClick={() => setOpenModal(true)}>
						Abrir Modal
					</GlobalButton>
				...
				<section className="space-y-4">
					...
					<GlobalDataGridShell
						...
						actions={<GlobalButton>Acción</GlobalButton>}
						footer={<p className="text-gray-400 text-sm">Paginación aquí</p>}
					>
						<p className="text-gray-300">
							Aquí iría un DataGrid real. Esto es solo un placeholder para
							validar el layout.
						</p>
					</GlobalDataGridShell>
				</section>
