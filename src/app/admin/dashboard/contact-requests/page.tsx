...
export default function AdminContactRequestsPage() {
	...
	const text = useMemo(
		() => ({
			...
			empty:
				lang === "es" ? "No se encontraron solicitudes." : "No requests found.",
			error:
				lang === "es"
			...
			serviceClass: lang === "es" ? "Clase de servicio" : "Service class",
	...
	const handleStatusChange = async (
		...
		try {
			...
			console.error(
				"[AdminContactRequestsPage] status update error:",
				updateError,
			);
			setItems(previous);
